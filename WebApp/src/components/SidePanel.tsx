...
const SidePanel: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // On initial load, check width and collapse if mobile
  ...
  return (
    <>
      {/* Mobile Backdrop - closes sidebar when clicked outside on mobile */}
      {!isCollapsed && (
        <div 
      ...
      <div
        className={`
          ...
          /* Mobile Overlay Behavior: High z-index ensures it sits on top */
          z-[100]
        `}
      >
        {showJoyride && (
        ...
        <button
          ...
          className="absolute -right-3 top-8 w-6 h-6 bg-black border border-emerald-500/30 rounded-full flex items-center justify-center text-emerald-400 hover:bg-emerald-500/10 transition-colors duration-200 z-[101]"
        >
